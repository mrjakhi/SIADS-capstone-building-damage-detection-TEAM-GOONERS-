...
class DisasterDataset(Dataset):
    ...
    @classmethod
    def apply_transform(self, pre_img, post_img):
        '''
    ...
    @classmethod
    def slice_tile(self, pre_img, post_img):
        ...
        for i in h_idx: 
            for j in w_idx:
                ...
                # sliced_dict[str(counter)] = {'pre_image': pre_img_sub, 
                #                              'post_image': post_img_sub} # Normalize o/p is tensor
    ...
    def __getitem__(self, idx):
        ...
        sliced_dict = self.slice_tile(pre_img, post_img)
        #print(type(pre_img))
